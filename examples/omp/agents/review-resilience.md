...
1. `skill://review-resilience` — (equivalently `skills/review-resilience/SKILL.md`)
2. `.omp/skills/review-resilience/SKILL.md` (project)
3. `~/.omp/agent/skills/review-resilience/SKILL.md` (global)

...
1. `skill://sdd-design` — (equivalently `skills/sdd-design/SKILL.md`) — your phase contract: read the proposal (required) and specs, and capture HOW the change will be implemented.

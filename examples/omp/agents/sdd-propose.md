...
1. `skill://sdd-propose` — (equivalently `skills/sdd-propose/SKILL.md`) — your phase contract: read the exploration (optional upstream) and produce a structured proposal.

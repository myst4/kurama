...
PERSISTENCE NOTE:
Sub-agents handle persistence automatically — each phase saves its artifact under "sdd/$ARGUMENTS/{type}" (the openspec path per skills/_shared/openspec-convention.md).

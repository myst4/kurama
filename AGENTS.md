...
| `skill-creator` | When adding a skill to Kurama — frontmatter the harness indexes, a manifest group, the AGENTS.md row, and a mutation-checked test. | [`skills/skill-creator/SKILL.md`](skills/skill-creator/SKILL.md) |
